...
1.  **Skill Check**: Analyze request for domain → Check `.agent/skills/`.
2.  **Discovery**: If no skill exists, invoke `skill-creator` to build it.
3.  **Persistence**: Register new skills in `ARCHITECTURE.md`.
4.  **Decompose**: Break task into subtasks for specialized agents.
5.  **Invoke**: Agent Tool for specialists.
6.  **Synthesize**: Results into cohesive output.
